        ...
        <div class="col-md-8 offset-md-2 border bg-light mt-5 mb-5">
            <div class="p-5"> 
                <form action="" method="POST">
                    @csrf
                    <div class="m-5">
                        <label for="comment" class="form-label">返信内容</label>
                        <textarea name="comment" class="form-control" id="exampleFormControlTextarea1" rows="8">{{ $reply->comment }}</textarea>
                    </div>
                    <div class="text-center mr-5">
                        <button type="submit" class="btn btn-outline-secondary col-6">
